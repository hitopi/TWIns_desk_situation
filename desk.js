window.addEventListener('DOMContentLoaded', (event) => {
  ...
  logoutButton.addEventListener('click', () => {
      ...
      if (currentUser) {
          ...
          // 出席時刻をスプレッドシートに送信
          if (presentTime) {
              fetch('https://script.google.com/macros/s/https://script.google.com/macros/s/AKfycbz8g0OALybbPIN4O521tidAOv3qyYg4JS8xItvW9hBLGE9RZqk0_Gm-j6wCJWVNglzRYg/exec/exec', {
                  method: 'POST',
                  body: JSON.stringify({
