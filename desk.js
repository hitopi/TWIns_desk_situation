window.addEventListener('DOMContentLoaded', (event) => {
  ...
  absentButton.addEventListener('click', () => {
    if (currentUser && canChangeStatus) {
      ...
      localStorage.setItem(currentUser.textContent + '_time', statusTime);
    }
  });
...
function sendDataToSpreadsheet(user, date, loginTime, logoutTime) {
  var data = {
    'user': user,
    'date': date,
    'loginTime': loginTime,
  ...
  fetch('https://script.google.com/macros/s/AKfycbw_nQVTAesEz5DekqD89g5uTQt0MHOIUjPOxLGBNwY0EA2ipvvmLxKnE_TnSmHZ5sM6/exec', {
    method: 'POST',
    headers: {
